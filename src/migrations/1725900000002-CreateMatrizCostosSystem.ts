...
export class CreateMatrizCostosSystem1725900000002 implements MigrationInterface {
  name = 'CreateMatrizCostosSystem1725900000002';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // 1. Tabla de matriz de costos base
    ...
    // 5. Seed: Matriz de costos base (del CSV)
    await queryRunner.query(`
    ...
    // 6. Seed: Catálogo de estudios (del CSV)
    await queryRunner.query(`
    ...
    // 7. Seed: Catálogo de procedimientos (del CSV)
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP TABLE IF EXISTS coberturas_aseguranza;');
    await queryRunner.query('DROP TABLE IF EXISTS catalogo_procedimientos;');
    await queryRunner.query('DROP TABLE IF EXISTS catalogo_estudios;');
    await queryRunner.query('DROP TABLE IF EXISTS matriz_costos;');
    await queryRunner.query('DROP TYPE IF EXISTS tipo_visita_costo;');
    await queryRunner.query('DROP TYPE IF EXISTS tipo_consulta_costo;');
  }
}
