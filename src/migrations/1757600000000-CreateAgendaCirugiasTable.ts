...
export class CreateAgendaCirugiasTable1757600000000 implements MigrationInterface {
  name = 'CreateAgendaCirugiasTable1757600000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP POLICY IF EXISTS agenda_cirugias_recepcionista_all ON agenda_cirugias;
      DROP POLICY IF EXISTS agenda_cirugias_doctor_own ON agenda_cirugias;
      DROP POLICY IF EXISTS agenda_cirugias_admin_all ON agenda_cirugias;
      DROP TABLE IF EXISTS agenda_cirugias;
      DROP TYPE IF EXISTS agenda_cirugia_estado;
    `);
  }
}
