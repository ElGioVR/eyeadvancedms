...
export class CreateCrearCirugiaRPC1800000000180 implements MigrationInterface {
  name = 'CreateCrearCirugiaRPC1800000000180';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      BEGIN
        ...
        -- ---------------------------------------------------------------
        -- VAL-001: Paciente existe (activo/expediente no disponibles en el
        -- esquema actual; se valida existencia y nombre completo)
        -- ---------------------------------------------------------------
