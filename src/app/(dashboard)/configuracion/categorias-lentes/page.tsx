        ...
        <table className="w-full min-w-[480px]">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/50">
              ...
              <th className="px-4 sm:px-6 py-3 text-left text-xs font-bold uppercase tracking-wider text-gray-400">Stock</th>
          ...
          <tbody className="divide-y divide-gray-50">
            {filtered.map((cat) => (
              <tr key={cat.id} className="group transition-colors hover:bg-gray-50/60">
                ...
                <td className="hidden sm:table-cell px-6 py-4 text-sm text-gray-500 max-w-xs">{cat.descripcion}</td>
                <td className="px-4 sm:px-6 py-4">
