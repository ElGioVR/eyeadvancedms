...
export default function AseguranzasPage() {
  ...
  }, [formNombre, formTelefono, formDireccion, formContacto, refetch, handleCloseSidebar, toast]);
  ...
  }, [editingItem, formNombre, formTelefono, formDireccion, formContacto, refetch, handleCloseSidebar, toast]);
      ...
      <div className="flex-1 min-w-0">
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-12 text-center">
            ...
            <p className="text-sm font-medium text-gray-500">No se encontraron aseguranzas</p>
          </div>
        ) : (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((item) => {
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {item.activo === false && (
                            <span className="text-[10px] font-bold text-gray-400 uppercase">Inactiva</span>
                          )}
                        </div>
                      </div>
